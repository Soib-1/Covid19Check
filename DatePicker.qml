        ...
        Column {
            Item { // month year header
                ...
                Text { // month year
                    ...
                    text: ['Styczeń', 'Luty', 'Marzec', 'Kwiecień', 'Maj', 'Czerwiec',
                           'Lipiec', 'Sierpień', 'Wrzesień', 'Październik', 'Listopad', 'Grudzień'][month] + ' ' + year
                ...
                Repeater {
                    ...
                    delegate: Rectangle { // index is 0 to 48
                        ...
                        Text {
                            ...
                            text: {
                                if(day < 0)                                               ['Ndz', 'Pon', 'Wt', 'Śr', 'Czw', 'Pt', 'Sob'][index] // Su-Sa
